...
// src/components/Dashboard_sidebar.tsx
...
//   { name: "Dashboard", icon: LayoutDashboard, path: "/dashboard" },
//   { name: "Job Listing", icon: List, path: "/dashboard/joblisting" },
//   { name: "User", icon: UserCog, path: "/dashboard/manageuser" }, // Admin only
// ];
...
//     (item) => item.name !== "User" || user?.role === "Admin",
//   );
...
//                 }`}
//               >
//                 <CircleUserRound size={isOpen ? 22 : 24} />
//                 {isOpen && (
//                   <span className="text-sm md:text-base font-medium md:font-semibold tracking-wide">
//                     {user?.name || "Profile"}
//                   </span>
